                    ...
                    <div class="content">
                        ...
                        <form:form modelAttribute="discountCode" class="pure-form" action="${pageContext.request.getContextPath()}/mvc/discount_code/${action}">
                            <fieldset>
                                ...
                                <form:input path="discountCode" placeholder="折扣代號" readonly="${readonly}" /><p />&nbsp;<form:errors path="discountCode" style="color: red" /><p />
                                <form:input path="rate" placeholder="折扣" /><p />&nbsp;<form:errors path="rate" style="color: red" /><p />
